      ...
      <vee-form :validation-schema="schema" :initial-values="song" @submit="edit">
        <div class="mb-3">
          ...
          <vee-field type="text" name="modified_name"
                     ...
                     @input="updateUnsavedFlag(true); show_alert = false"
          />
        ...
        <div class="mb-3">
          ...
          <vee-field type="text" name="genre"
                     ...
                     @input="updateUnsavedFlag(true); show_alert = false"
          />
          <ErrorMessage class="text-red600" name="genre"/>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      alert_message: 'Updating song, please wait...',
    };
  },
  methods: {
    async edit(values) {
      ...
      this.alert_message = 'Updating song, please wait...';
      ...
      try {
        ...
        this.alert_message = 'Error while updating the song, try again.';
        return;
      }
      ...
      this.alert_message = 'Song updated';
    },
    async deleteSong() {
