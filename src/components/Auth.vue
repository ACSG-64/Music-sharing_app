          ...
          <ul class="flex flex-wrap mb-4">
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition" href="#"
                 :class="{'hover:text-white text-white bg-blue-600': isLoginTab}"
                 @click.prevent="isLoginTab = true">Login</a>
            </li>
            <li class="flex-auto text-center">
              <a class="block rounded py-3 px-4 transition" href="#"
                 :class="{'hover:text-white text-white bg-blue-600': !isLoginTab}"
                 @click.prevent="isLoginTab = false">Register</a>
            </li>
          </ul>

          <!-- Login Form -->
          <app-login-form v-if="isLoginTab"/>
          <!-- Registration Form -->
